<template>
  <div class="modal fade" :id="'silinmis-modal'+table_name" tabindex="-1" role="dialog" aria-hidden="true"
    style="display: none;">
  ...
  export default {
    ...
    methods: {
      ...
      getTable() {
        ...
        axios.post(this.$store.getters.getToken + '/tables/' + this.table_name + '/deleted', {
