...
(function ($) {
  ...
  <div class="theme-colors">
    <div class="p-4">
    <p class="text-muted mb-2">Açık Temalar</p>
    <div class="d-flex flex-row justify-content-between mb-3">
      <a href="#" data-theme="dore.light.bluenavy.min.css" id='tematetik' class="theme-color theme-color-bluenavy"></a>
    ...
    <p class="text-muted mb-2">Koyu Temalar</p>
    <div class="d-flex flex-row justify-content-between mb-3">
...
`;
  ...
  loadStyle(window.location.origin+'/_assets/css/'+ theme, onStyleComplete);
  //$('head').append( $('<link rel="stylesheet" />').attr('href', window.location.origin+'/_assets/css/'+theme) );
